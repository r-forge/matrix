...
@   
  \caption{Location of non-zero elements in the last 19 rows of the
    ...
    \var{ScotsSec} data.  Darker squares indicate larger
    magnitudes. Rows and columns are numbered from zero.}
  \label{fig:Lnonzero}
\end{figure}
...
@   
  \caption{Location of non-zero elements in the last 19 rows of unit
