...
setMethod("t", signature(x = "CsparseMatrix"),
	  function(x)
	  .Call("Csparse_transpose", x, PACKAGE = "Matrix.new"))
...
setMethod("%*%", signature(x = "CsparseMatrix", y = "CsparseMatrix"),
          function(x, y) .Call("Csparse_Csparse_prod", x, y, PACKAGE = "Matrix.new"))

setMethod("%*%", signature(x = "CsparseMatrix", y = "denseMatrix"),
          function(x, y) .Call("Csparse_dense_prod", x, y, PACKAGE = "Matrix.new"))
...
setAs("CsparseMatrix", "denseMatrix",
      function(from) .Call("Csparse_to_dense", from, PACKAGE = "Matrix.new"))
