...
setAs("dsTMatrix", "dsCMatrix",
      function(from)
      ## pre-Cholmod: .Call("dsTMatrix_as_dsCMatrix", from, PACKAGE = "Matrix.new")
      .Call("Tsparse_to_Csparse", from, PACKAGE = "Matrix.new")
      )
...
setAs("dsTMatrix", "dgTMatrix",
      function(from) .Call("dsTMatrix_as_dgTMatrix", from, PACKAGE = "Matrix.new"))
...
setAs("dsTMatrix", "dsyMatrix",
      function(from) .Call("dsTMatrix_as_dsyMatrix", from, PACKAGE = "Matrix.new"))
...
setMethod("writeHB", signature(obj = "dsTMatrix"),
          ...
          .Call("Matrix_writeHarwellBoeing",
                ...
                as.character(file), "DST", PACKAGE = "Matrix.new"))
