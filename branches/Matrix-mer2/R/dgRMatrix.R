...
setAs("dgRMatrix", "dgTMatrix",
      function(from) .Call("compressed_to_dgTMatrix", from, FALSE, PACKAGE = "Matrix.new"))

##setAs("dgRMatrix", "matrix",
##      function(from) .Call("csc_to_matrix", from, PACKAGE = "Matrix.new"))

##setAs("dgRMatrix", "dgeMatrix",
##      function(from) .Call("csc_to_dgeMatrix", from, PACKAGE = "Matrix.new"))

##setAs("matrix", "dgRMatrix",
##      function(from) {
##          storage.mode(from) <- "double"
##          .Call("matrix_to_csc", from, PACKAGE = "Matrix.new")
##      })

##setMethod("diag", signature(x = "dgRMatrix"),
##          function(x = 1, nrow, ncol = n) .Call("csc_getDiag", x, PACKAGE = "Matrix.new"))
...
##          function(x) .Call("csc_transpose", x, PACKAGE = "Matrix.new"),
