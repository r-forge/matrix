...
SEXP diagonal_as_dense(SEXP, const char *, char, int, char);
SEXP R_diagonal_as_dense(SEXP, SEXP, SEXP, SEXP);
...
SEXP diagonal_as_sparse(SEXP, const char *, char, char, char);
SEXP R_diagonal_as_sparse(SEXP, SEXP, SEXP, SEXP);
