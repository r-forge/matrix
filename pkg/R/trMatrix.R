...
setAs("trMatrix", "geMatrix",
      function(from) .Call("trMatrix_as_geMatrix", from) )

setAs("trMatrix", "matrix",
      function(from) .Call("trMatrix_as_matrix", from) )

setMethod("%*%", signature(x = "trMatrix", y = "geMatrix"),
	  function(x, y) .Call("trMatrix_geMatrix_mm", x, y))

setMethod("%*%", signature(x = "geMatrix", y = "trMatrix"),
	  function(x, y) .Call("trMatrix_geMatrix_mm_R", y, x))
