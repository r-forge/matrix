...
setMethod("[", signature(x = "denseMatrix", i = "numeric", j = "missing",
			 drop = "logical"),
          function (x, i, drop) {
...
setMethod("[", signature(x = "denseMatrix", i = "missing", j = "numeric",
			 drop = "logical"),
          function (x, j, drop) {
...
setMethod("[", signature(x = "denseMatrix", i = "numeric", j = "numeric",
			 drop = "logical"),
          function (x, i, j, drop) {
