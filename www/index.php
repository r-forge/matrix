...
<p>
Welcome to <a href="https://r-forge.r-project.org/projects/matrix/">the Matrix project</a> on R-Forge, home of R packages <a href="https://cran.r-project.org/package=Matrix"><b>Matrix</b></a> and <a href="https://cran.r-project.org/package=MatrixModels"><b>MatrixModels</b></a>.  These provide S4 classes and methods for representing, operating on, and modelling with sparse and dense matrices.  Since R version 2.9.0, <b>Matrix</b> has belonged to a list of "recommended" packages bundled in standard installations of R (in the default library, alongside <b>base</b>).  Hence it is typically possible to load a version of <b>Matrix</b> "out of the box" (with, as usual, <code>library(Matrix)</code>).
</p>
...
<p>
Note that <em>source</em> installation (as opposed to <em>binary</em> installation) requires compilers and other tools; see manual <a href="https://stat.ethz.ch/R-manual/R-patched/doc/manual/R-admin.html#Installing-packages"><i>R Installation and Administration</i></a> for platform-specific details.
</p>
...
<p>
The Matrix project is maintained in a Subversion ("SVN") repository.  If you have installed Subversion and have <code>svn</code> on your <code>PATH</code>, then you can check out the latest development version of <b>Matrix</b> with:
</p>
